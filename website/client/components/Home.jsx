      ...
      <div className='main-section-b'>
        ...
        <div className='sub-section'>
          ...
          <div className='demo-launch-buttons'>
            <button onClick={() => openInNewTab('http://livestatedb/storedemo')}>Storefront Demo</button>
            <button onClick={() => openInNewTab('http://livestatedb/inventorydemo')}>Inventory Manager Demo</button>
          </div>
          </div>
        </div>
      </div>
